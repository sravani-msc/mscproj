<%@ Page Title="" Language="C#" MasterPageFile="~/Anonymous.master" AutoEventWireup="true" CodeBehind="SCLogin.aspx.cs" Inherits="SurveyWeb.SCLogin" %>
    ...
    <table style="width: 100%; border-style: solid; border-width: 1px">
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center">
                <strong>Survey Child Login</strong></td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
